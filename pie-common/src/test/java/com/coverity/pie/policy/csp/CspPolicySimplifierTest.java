...
public class CspPolicySimplifierTest {
    @Test
    public void testBasicCollapse() {
        CspPolicy policy = new CspPolicy();
        
        policy.getPolicyEntries().addAll(buildCspPolicy(
                new Object[] {
                        new Object[] {
                            "/a/b/c", new Object[] {
                            ...
                            "/c/d/e", new Object[] {
                                    new Object[] { "object-src", new String[] { "1.1", } },
                                    new Object[] { "script-src", new String[] { "2.2", } },
                            }
                        }, new Object[] {
                            "/c/d/f", new Object[] {
                                    new Object[] { "object-src", new String[] { "3.3", } },
                                    new Object[] { "script-src", new String[] { "4.4", } },
                            }
                        }, new Object[] {
                            "/c/g/h", new Object[] {
                                    new Object[] { "object-src", new String[] { "5.5", } },
                                    new Object[] { "script-src", new String[] { "6.6", } },
                            }
                        }, new Object[] {
                            "/c/g/j", new Object[] {
                                    new Object[] { "object-src", new String[] { "7.7", } },
                                    new Object[] { "script-src", new String[] { "8.8", } },
                            }
                        },
                }));
        policy = CspPolicySimplifier.simplifyPolicy(policy);
                
        Assert.assertEquals(toArray(policy.getPolicyEntries()), new Object[] {
                new Object[] {
                        "/a/b/*", new Object[] {
                                new Object[] { "object-src", new String[] { "*.c.example.com", "oof.rab.com", } },
                                new Object[] { "script-src", new String[] { "*.c.example.com", "foo.bar.com", } },
                        }
                }, new Object[] {
                        "/c/**", new Object[] {
                                new Object[] { "object-src", new String[] { "1.1", "3.3", "5.5", "7.7", } },
                                new Object[] { "script-src", new String[] { "2.2", "4.4", "6.6", "8.8", } },
                        }
                },
            });
    }
